                          ...
                          <div className="images_testmonial flex  justify-around">
                            ...
                            <div className="text-center">
                              <img
                                ...
                                alt=""
                                className="h-24 w-24 border-4 mx-auto p-1 border-[#494f9f]object-contain rounded-full"
                              />
                  ...
                  <div className="w-full md:w-1/2 md:px-3">
                    <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                      <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-1xl md:text-2xl lg:text-3xl xl:text-5xl">
                        ...
                        <span className="block text-[#494f9f] xl:inline">
                      ...
                      <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                        <a
                          href="#_"
                          className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-[#494f9f] rounded-md sm:mb-0 hover:bg-orange-700 sm:w-auto"
                        >
                          Try It Free
                          <svg
              ...
              <div className="container   mx-auto ">
                <div className="rounded-lg overflow-hidden  ">
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center md:max-w-3xl	 w-full px-2">
                    ...
                    <button className="bg-[#494f9f] text-white	md:py-3 sm:py-2 py-2  px-12 text-base	 rounded-3xl font-bold	mt-8">
                      All Projects
                    </button>
                  </div>
                </div>
