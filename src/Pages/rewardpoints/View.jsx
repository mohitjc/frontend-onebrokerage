          ...
          <div className="grid grid-cols-12 gap-4">
              ...
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-6">
                  <label className="profileheddingcls">Transaction for </label>
                  <div className="profiledetailscls">{data?.transaction_for || "--"}</div>
                </div>
                
              </div>
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-6">
                  <label className="profileheddingcls">Rewards Points </label>
                  <div className="profiledetailscls">{data?.reward_points || "--"}</div>
                </div>
