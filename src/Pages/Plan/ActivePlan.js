  ...
  return (
    <Layout>
      ...
      <div className="mt-6 shadow-box bg-white rounded-lg overflow-hidden">
        <div className="bg-[#494f9f] !p-5 flex gap-[18px] items-center">
        ...
        <div className="!p-5">
          <div className="flex justify-between">
            ...
            <div className="flex !gap-2 items-center">
              ...
              <Link
                className="bg-btn bg-[#494f9f] hover:no-underline !px-4 h-10 flex items-center justify-center text-sm font-normal text-white hover:!text-white rounded-lg"
                to="/plans">
                Change Plan
              </Link>
            </div>
