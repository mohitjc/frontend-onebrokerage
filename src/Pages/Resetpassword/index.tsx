      ...
      <AuthLayout>
        <form className="" onSubmit={hendleSubmit}>
          ...
          <div className=" mt-6">
            <button
              type="submit"
              className="w-full text-white bg-[#EB6A59]   focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center  mb-4"
            >
              Save
            </button>
          </div>
