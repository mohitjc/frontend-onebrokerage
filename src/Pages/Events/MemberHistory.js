      ...
      <table className='w-full'>
        <thead className='!border border-[#EAECF0]'>
          <tr className='!border border-[#EAECF0]'>
            <th className='cursor-pointer text-[#82838B] !border-l-0 font-normal text-sm !border border-[#EAECF0] !px-5 text-left bg-[#F7FAFF] !py-3'>Title</th>
        ...
        {eventDetail?.map((ele)=>{
            return (
              <tr>
                ...
                <td className=' text-typo !px-2 text-sm font-normal !py-3 !border text-center border-[#EAECF0]'>{ele?.eventsDetails?.description}</td>
