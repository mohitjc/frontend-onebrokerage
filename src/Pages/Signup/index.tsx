      ...
      <AuthLayout>
        <form className="w-11/12 md:w-7/12	mx-auto" onSubmit={hendleSubmit} autoComplete="off">
          ...
          <input
            ...
            value={form.loginId}
            className={`shadow-box border-1 border-gray-300 relative bg-gray-100 mb-3 w-full text-sm placeholder:text-gray-500 rounded-lg h-12 flex items-center gap-2 overflow-hidden px-2 hover:ring-orange-500 focus:border-[#EB6A59]${
          ...
          {submitted && !remember ? (
            <>
              <div className="text-[#EB6A59] text-sm capitalize mt-3">
          ...
          <div className="mt-8">
            <button
              type="submit"
              className="px-4 w-full text-sm font-normal text-white h-12 flex items-center justify-center gap-2 !bg-[#EB6A59] rounded-lg shadow-btn hover:opacity-80 transition-all focus:ring-2 ring-[#EDEBFC] disabled:bg-[#D0CAF6] disabled:cursor-not-allowed"
            >
              Sign Up
            </button>
          </div>
          ...
          <p className="text-sm mt-3 text-center">
            ...
            <Link to="/login" className="text-[#EB6A59] text-sm">
              Sign In
            </Link>
          </p>
        </form>
