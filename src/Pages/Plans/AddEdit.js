...
const AddEditPlan = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const getStripeId = (itm) => {
      let ext = pricing.find(
        (pitm) =>
          pitm.interval_count == itm.interval_count &&
          pitm.currency == itm.currency
      );
  ...
  const getFeatures = (feature = {}) => {
    let f = feature;
    ApiClient.get("api/grouped/features", {
      page: 1,
      count: 100,
      status: "active",
    }).then((res) => {
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 md:col-span-12">
                ...
                <h5 className="monthTerm">
                  Term: 1 Month<span className="star">*</span>
                </h5>
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="col-spam-12 md:col-span-4 pl-3 mb-3">
                    ...
                    <input className="relative shadow-box bg-white w-full rounded-lg h-10 flex items-center gap-2 overflow-hidden px-2" />
                  </div>
                  {/* )
                                })} */}
                </div>
              ...
              <div className="col-span-12 md:col-span-12">
                <hr className="borderHr" />
                <h5 className="monthTerm">
                  Term: 3 Months<span className="star">*</span>
                </h5>
                <div className="grid grid-cols-12 gap-4">
                  {/* {currencys && currencys.map((item, index) => ( */}
                  <div className="col-spam-12 md:col-span-4 pl-3 mb-3">
              ...
              <div className="col-span-12 md:col-span-12">
                ...
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="col-spam-12 md:col-span-4 pl-3 mb-3">
                    ...
                    <input className="relative shadow-box bg-white w-full rounded-lg h-10 flex items-center gap-2 overflow-hidden px-2"></input>
                  </div>
                  {/* ))} */}
                </div>
              </div>
              <div className="col-span-12 md:col-span-12">
                <hr className="borderHr" />
                <h5 className="monthTerm">
                  Term: 12 Months<span className="star">*</span>
                </h5>
                <div className="grid grid-cols-12 gap-4">
                  {/* {currencys && currencys.map((item, index) => ( */}
                  <div className="col-spam-12 md:col-span-3 pl-3 mb-3">
                    <label>
                      Price <span className="capitalize"></span>
                      <span className="star">*</span>
                    </label>
                    <input className="relative shadow-box bg-white w-full rounded-lg h-10 flex items-center gap-2 overflow-hidden px-2"></input>
                  </div>
