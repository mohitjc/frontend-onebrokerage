...
const ApprovedSubCarrier = () => {
  ...
  const statusChange = (itm) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        loader(true);
        ApiClient.put(shared.statusApi, {
          model: "users",
          id: itm.id,
          status,
        }).then((res) => {
    ...
    <Layout>
      <div>
        ...
        <h3 className="text-2xl font-semibold text-[#111827]">
            {" "}
            Approved Sub-Carriers
          </h3>
          <p class="text-sm font-normal text-[#75757A]">
            Here you can see all about your Approved Sub-Carriers
          </p>
        </div>
...
export default ApprovedSubCarrier;
