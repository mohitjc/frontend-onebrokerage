                                                                ...
                                                                <>
                                                                    <Disclosure.Button className="flex w-full items-center cursor-pointer justify-between rounded-lg bg-orange-100 px-4 py-2 text-left text-sm font-medium text-purple-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                                                                        <div className=' '>
                                                                            ...
                                                                            <div className='flex flex-col gap-y-1'>
                                                                                <h4 className='text-lg font-bold text-[#2b2b2b]'>{ele?.eventsDetails?.[0]?.title}</h4>
                                                                                <p className='text-sm text-gray-500'>{ele?.ConnectMeetId}</p>
                                                                            </div>
                                                                        </div>
                                                                        <ChevronUpIcon
                                                                    ...
                                                                    <Disclosure.Panel className="px-4 pb-2 pt-4 text-sm text-gray-500">
                                                                        {ele?.membersDetails?.map((element) => {
                                                                            return (
                                                                                <div className=''>
                                                                                    <p className='flex items-center mb-2 gap-1 text-[#75757A] capitalize text-[14px] '><LuUser2 className='text-black !text-[16px]' />{element?.fullName}</p>
                                                                                    <p className='flex items-center mb-2 gap-1 text-[#75757A] capitalize text-[14px] '><MdOutlineEmail className='text-black !text-[16px]' />{element?.email}</p>
                                                                                </div>
                                                                            )
                                                                        })}
