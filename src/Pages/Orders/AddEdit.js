          ...
          <div className="pprofile1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="mb-3">
                ...
                {!form.video && (
                  <label
                    className={`block cursor-pointer text-gray-500 bg-white border-2 border-dashed border-[#494f9f] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-4 py-4 text-center `}
                  >
                    <input
                      type="file"
                      className="hidden"
                    ...
                    <div className="flex flex-row gap-2 items-center justify-center">
                      <FiPlus className="text-2xl text-[#494f9f]" />
