      ...
      <AuthLayout>
        <form className="centerLogin" onSubmit={hendleSubmit}>
          ...
          <div className="buttons">
            <button
              type="submit"
              className="w-full text-white bg-orange-400 bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center loginclass mb-4"
            >
              Send Recovery Email
            </button>
          </div>
