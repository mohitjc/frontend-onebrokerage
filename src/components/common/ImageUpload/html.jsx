...
const Html = ({
  ...
  return (
    <>
      <label
        className={`inline-block cursor-pointer text-white bg-[#EB6A59] bg-[#EB6A59] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ${
          img && !multiple ? "d-none" : ""
        }`}
      >
        <input
