        ...
        <>
          <div className="selectDropdown">
            ...
            <div className="dropdown addDropdown">
              <Menu as="div" className="relative list_box_active_state ml-auto">
                ...
                >
                  <Menu.Items
                    ...
                    }  focus:!outline-[#494f9f] focus:!outline text-sm absolute z-40 w-full ${
              ...
              {/* <button disabled={disabled} className={`text-white bg-[#494f9f] bg-[#494f9f] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dropdown-toggle removeBg ${className}`} type="button" id={"dropdownMenuButton" + id} data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
