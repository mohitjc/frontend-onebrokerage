...
const Html = ({ options, dynamicStyle = false, className = null, selectedValues, handleChange=()=>{}, displayValue, id='', placeholder, required, disabled, name='', noDefault, theme = 'normal' }:any) => {
