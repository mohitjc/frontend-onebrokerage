            ...
            <form onSubmit={handleSubmit}>
                <div className="form-row roleForm">
                    ...
                    <div className="col-md-12 mb-3 text-right">
                        <button className='text-white bg-[#494f9f] bg-[#494f9f] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Update</button>
                    </div>
                </div>
            </form>
        </>
