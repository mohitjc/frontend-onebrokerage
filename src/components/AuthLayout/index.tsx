...
const AuthLayout=({children}:any)=>{
    return <>
      <div className='grid items-center grid-cols-12 '>
       ...
       <div className="col-span-12 md:col-span-5 lg:col-span-5 xl:col-span-4 hidden md:block">
         ...
         <div className=" w-full max-w-md px-8 py-6 mx-auto overflow-y-auto rounded-lg ">
           <Link to="/" className="absolute md:top-[10px] md:left-[2px] lg:top-[4px] lg:left-[4px]  xl:top-[11px] xl:left-[4px] xl:w-[180px] z-[99] "><img src="/assets/img/logo.png" className="md:w-[130px] lg:w-[150px]  mx-auto  " alt="logo" /></Link>
